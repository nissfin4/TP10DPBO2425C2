...
class DivisiViewModel // Class untuk menjadi penghubung antara View dan Model 
{
    ...
    public function save($nama_divisi, $deskripsi)
    {
        return $this->model->create($nama_divisi, $deskripsi);
    }

    // Fungsi untuk mengupdate data divisi berdasarkan ID
    public function update($id,$nama_divisi,$deskripsi)
    {
        return $this->model->update($id,$nama_divisi,$deskripsi);
    }
